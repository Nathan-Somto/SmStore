...
function CategoryLinks() {
  ...
  return (
    <div className='flex flex-wrap justify-center  w-full my-12'>
        {
            items.map((item, _index)=><Link to={item.url} key={item.heading} className="max-h-[350px] group overflow-hidden relative border border-solid mr-3 mb-3 rounded-[4px] border-[#cbcaca]">
